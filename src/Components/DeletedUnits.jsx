...
const DeletedUnits = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
    .post('https://api.goldenbeit.com/dashboard/paginated-trashed-units',
      {},
      {
        headers: {
  ...
  const handlePaginate = (pageNumber) => {
    setLoading(true);
    axios.post('https://api.goldenbeit.com/dashboard/paginated-trashed-units',
      {
  ...
  const handleDeleteUnit = (id) => {
    axios
    .delete(`https://api.goldenbeit.com/core/hard-delete-unit/${id}`,
